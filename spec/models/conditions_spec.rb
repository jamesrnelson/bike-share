...
describe Condition do
  ...
  describe 'class methods' do
    it 'should find the condition for the day with most rides' do
      create_list(:trip, 5, start_date: '2013-08-29 10:11:00')
      create_list(:trip, 15, start_date: '2013-09-15 10:11:00')
      create_list(:trip, 10, start_date: '2013-10-02')
      create(:condition, date: '2013-08-29')
      sep_condition = create(:condition, date: '2013-09-15')
      create(:condition, date: '2013-10-02')
    ...
    it 'should find the condition for the day with least rides' do
      ...
      create(:condition, date: '2013-09-15')
      create(:condition, date: '2013-10-02')
